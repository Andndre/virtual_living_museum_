        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div class="rounded-2xl bg-white p-12 text-center shadow-sm">
                    ...
                    <h3 class="mb-2 text-lg font-medium text-gray-900">Belum Ada Kritik & Saran</h3>
                    <p class="text-gray-600">Belum ada feedback dari pengguna. Kritik dan saran akan muncul di sini ketika pengguna mengirimkan feedback.</p>
                </div>
            @endif
        </div>
    </div>
