    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.pretest', $materi->materi_id) }}" class="text-gray-400 hover:text-gray-500">Pretest {{ $materi->judul }}</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <div class="mb-4">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Soal Pretest</h1>
                    <p class="mt-2 text-sm sm:text-base text-gray-600">Menambahkan soal pretest untuk materi: <strong>{{ $materi->judul }}</strong></p>
                </div>
                
                <!-- Action Button -->
                <div class="flex">
                    <a href="{{ route('admin.pretest', $materi->materi_id) }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <form action="{{ route('admin.pretest.store', $materi->materi_id) }}" method="POST">
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 space-x-3">
                        <a href="{{ route('admin.pretest', $materi->materi_id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                            Batal
                        </a>
