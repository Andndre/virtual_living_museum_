                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.virtual-museum.show', $museum->museum_id) }}" class="ml-1 text-gray-400 hover:text-gray-500">{{ $museum->nama }}</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <form method="POST" action="{{ route('admin.virtual-museum-object.store', $museum->museum_id) }}" enctype="multipart/form-data">
        @csrf
