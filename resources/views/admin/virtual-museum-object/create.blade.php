        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Tambah Object Virtual Living Museum</h1>
        ...
        <form method="POST" action="{{ route('admin.virtual-museum-object.store', $museum->museum_id) }}"
            ...
            <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-200 px-6 py-4">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Lengkapi data object virtual living museum yang akan
                        ditambahkan.</p>
                </div>
                ...
                <div class="space-y-6 px-6 py-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Gambar marker yang akan digunakan untuk mendeteksi AR.
                            File pattern `.patt` akan dibuat otomatis saat object disimpan.</p>
                    </div>
