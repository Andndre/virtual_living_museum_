                    ...
                    <div class="bg-white shadow rounded-lg">
                        <div class="px-4 py-5 sm:p-6 text-center">
                            <div class="mb-4">
                                ...
                                @else
                                    <div
                                        class="h-32 w-32 rounded-full bg-gray-300 flex items-center justify-center mx-auto">
                            ...
                            <div class="mt-2">
                                <span
                                    class="inline-flex px-3 py-1 text-sm font-medium rounded-full {{ $user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                    {{ ucfirst($user->role) }}
                                </span>
                            </div>
                        </div>
