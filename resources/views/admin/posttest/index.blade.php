                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    @empty
                        <div class="rounded-2xl bg-white p-12 text-center shadow-sm">
                            ...
                            <p class="text-gray-600 mb-4">Mulai tambahkan soal posttest untuk materi ini.</p>
                            <a href="{{ route('admin.posttest.create', $materi->materi_id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                <i class="fas fa-plus mr-2"></i>
                                Tambah Soal Pertama
                            </a>
                        </div>
