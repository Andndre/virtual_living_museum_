    ...
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin.posttest', $materi->materi_id) }}"
                                    class="text-gray-400 hover:text-gray-500">Posttest {{ $materi->judul }}</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <div class="mb-4">
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Tambah Soal Posttest</h1>
                    <p class="mt-2 text-sm text-gray-600 sm:text-base">Menambahkan soal posttest untuk materi:
                    ...
                    <div class="space-y-6 px-4 py-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <textarea name="pertanyaan" id="pertanyaan" rows="4"
                                ...
                                placeholder="Masukkan pertanyaan posttest" required>{{ old('pertanyaan') }}</textarea>
                            @error('pertanyaan')
