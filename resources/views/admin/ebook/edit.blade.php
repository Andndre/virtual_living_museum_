    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="mb-4 sm:mb-0">
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit E-book</h1>
                        <p class="mt-2 text-sm sm:text-base text-gray-600">Edit e-book untuk materi: <strong>{{ $materi->judul }}</strong></p>
                    </div>
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <form method="POST" action="{{ route('admin.ebook.update', [$materi->materi_id, $ebook->ebook_id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center p-3 bg-gray-50 rounded-lg border">
                                    ...
                                    <div class="ml-3 flex-1">
                                        ...
                                        @if(file_exists(storage_path('app/public/' . $ebook->path_file)))
                                        ...
                                        @else
                                            <span class="text-xs text-red-600 block">
                                                <i class="fas fa-exclamation-triangle mr-1"></i>File tidak ditemukan
                                            </span>
                                        @endif
                                    </div>
                                    @if(file_exists(storage_path('app/public/' . $ebook->path_file)))
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="path_file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="path_file" name="path_file" type="file" class="sr-only" accept=".pdf">
                                        </label>
                                    ...
                                    <p class="text-xs text-gray-500">
                                        PDF hingga 50MB
                                        @if($ebook->path_file)
                                            <br><span class="text-yellow-600">Kosongkan jika tidak ingin mengubah file</span>
                                        @endif
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 space-x-3">
                        ...
                        <button type="submit" 
                                class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-colors">
