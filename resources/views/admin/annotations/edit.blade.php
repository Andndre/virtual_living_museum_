<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <h1 class="text-2xl font-bold text-gray-900">Edit Label Annotation</h1>
                <p class="mt-2 text-sm text-gray-600">Edit label annotation "{{ $annotation->label }}"</p>
            </div>
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('admin.annotations.update', $annotation->annotation_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <select name="museum_id" id="museum_id"
                                    ...
                                    @foreach($museums as $museum)
                                        <option value="{{ $museum->museum_id }}" {{ old('museum_id', $annotation->museum_id) == $museum->museum_id ? 'selected' : '' }}>
                                            {{ $museum->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="label" id="label"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       value="{{ old('label', $annotation->label) }}" required maxlength="100"
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="number" name="position_x" id="position_x" step="0.000001"
                                               ...
                                               value="{{ old('position_x', $annotation->position_x) }}" required>
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="position_y" id="position_y" step="0.000001"
                                               class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                               value="{{ old('position_y', $annotation->position_y) }}" required>
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="position_z" id="position_z" step="0.000001"
                                               class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                               value="{{ old('position_z', $annotation->position_z) }}" required>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="display_order" id="display_order"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                       value="{{ old('display_order', $annotation->display_order) }}" min="0">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_visible" id="is_visible" value="1"
                                       ...
                                       {{ old('is_visible', $annotation->is_visible) ? 'checked' : '' }}>
