<x-elearning-layout>
    ...
    <div class="px-6 py-6 bg-primary text-white">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-2 mb-2">
                ...
                <span class="text-sm opacity-90">{{ __('app.elearning_task') }}</span>
            </div>
    ...
    <div class="bg-white rounded-t-3xl -mt-6 relative min-h-screen">
        <div class="px-6 py-8">
            <h2 class="text-xl font-bold text-center text-gray-900 mb-6">{{ __('app.elearning_task_list') }}</h2>
            ...
            @else
                <div class="bg-gray-100 rounded-2xl p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('app.elearning_no_tasks') }}</h3>
                    <p class="text-gray-600">{{ __('app.elearning_no_task_for_material') }}</p>
                </div>
            @endif
            ...
            <div class="mt-8 text-center">
                <a href="{{ route('guest.elearning.materi', $materi->materi_id) }}"
                   class="inline-flex items-center px-6 py-3 bg-primary text-white font-medium rounded-xl hover:bg-primary-dark transition-colors">
                    ...
                    {{ __('app.elearning_back_to_material') }}
                </a>
            </div>
        </div>
    </div>
