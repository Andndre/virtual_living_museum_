            ...
            @if ($isCompleted)
                ...
                <div class="mb-6 rounded-2xl bg-white p-6 shadow-sm">
                    <div class="text-center">
                        ...
                        <h3 class="mb-2 text-xl font-bold text-gray-900">{{ __('elearning.posttest.posttest_selesai') }}
                        </h3>
                    ...
                    <div class="mt-8">
                        <h4 class="mb-4 text-lg font-semibold text-gray-800">
                            {{ __('elearning.posttest.evaluasi_jawaban_anda') }}</h4>
                        <div class="space-y-6">
                            @php
                    ...
                    <form id="quiz-form" method="POST"
                        ...
                        <div class="mb-6 rounded-2xl bg-white p-6 shadow-sm">
                            <div class="mb-2 flex items-center justify-between">
                                <span
                                    class="text-sm font-medium text-gray-600">{{ __('elearning.posttest.progres') }}</span>
                                <span class="text-sm font-medium text-green-600" id="progress-text">1
                                    {{ __('elearning.posttest.dari') }}
                                    {{ $totalQuestions }}</span>
                            </div>
                                ...
                                <div class="space-y-3">
                                    @foreach (['A' => $question->pilihan_a, 'B' => $question->pilihan_b, 'C' => $question->pilihan_c, 'D' => $question->pilihan_d] as $key => $option)
                                        <label
                                            ...
                                            <input type="radio" name="answers[{{ $question->posttest_id }}]" value="{{ $key }}"
                                    ...
                                    @if ($question->pilihan_e)
                                        <label
                                            ...
                                            <input type="radio" name="answers[{{ $question->posttest_id }}]" value="E"
                                                class="mt-1 text-green-600 focus:ring-green-500" required>
                                            <div class="flex-1">
                                                <div class="flex items-center space-x-2">
                                                    <span
