    ...
    <div class="min-h-screen bg-gray-50 px-6 py-6">
        @if ($isCompleted)
            ...
            <div class="mb-6 rounded-2xl bg-white p-6 shadow-sm">
                ...
                {{-- Evaluasi Soal --}}
                <div class="mt-8">
                    <h4 class="mb-4 text-lg font-semibold text-gray-800">{{ __('elearning.pretest.evaluasi_jawaban_anda') }}</h4>
                    <div class="space-y-6">
                        @php
                ...
                <form id="quiz-form" method="POST"
                    ...
                    <div class="mb-6 rounded-2xl bg-white p-6 shadow-sm">
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-blue-600" id="progress-text">1 {{ __('elearning.pretest.dari') }}
                                {{ $totalQuestions }}</span>
                        </div>
                        ...
                        <div class="quiz-question {{ $index === 0 ? '' : 'hidden' }} mb-6 rounded-2xl bg-white p-6 shadow-sm"
                            ...
                            <div class="mb-6">
                                <div class="mb-4 flex items-center space-x-3">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900">{{ __('elearning.pretest.soal') }} {{ $index + 1 }}</h3>
                                </div>
                            ...
                            <div class="space-y-3">
                                @foreach (['A' => $question->pilihan_a, 'B' => $question->pilihan_b, 'C' => $question->pilihan_c, 'D' => $question->pilihan_d] as $key => $option)
                                    <label
                                        ...
                                        <input type="radio" name="answers[{{ $question->pretest_id }}]"
                                            value="{{ $key }}"
                                ...
                                @if ($question->pilihan_e)
                                    <label
                                        ...
                                        <input type="radio" name="answers[{{ $question->pretest_id }}]"
                                            value="E" class="mt-1 text-blue-600 focus:ring-blue-500" required>
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2">
                                                <span
