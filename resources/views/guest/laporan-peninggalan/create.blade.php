        ...
        <form action="{{ route('guest.laporan-peninggalan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="space-y-5">
                    {{-- Nama Peninggalan --}}
                    <div>
                        <label for="nama_peninggalan" class="block text-sm font-medium text-gray-700 mb-1">Nama Peninggalan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <div id="map" class="h-64 w-full bg-gray-100 rounded-lg mb-2"></div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="gambar" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-sm text-gray-500"><span class="font-medium">Klik untuk unggah</span> atau seret dan lepas</p>
            ...
            {{-- Submit Button --}}
            <div class="fixed bottom-16 left-0 right-0 px-6 pb-6">
                <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white font-medium py-3 rounded-lg transition-colors">
                    Simpan Laporan
                </button>
            </div>
        </form>
